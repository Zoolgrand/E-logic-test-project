...
export const useCreateAccount = props => {
    ...
    const [assignCompareListToCustomer] = useMutation(
        ASSIGN_COMPARE_LIST_TO_CUSTOMER
    );
        ...
        async formValues => {
            ...
            try {
                ...
                if (compareId) {
                    ...
                    await assignCompareListToCustomer({
                        variables: {
                            uid: compareId
                        }
                    });
                    await storage.removeItem('compare_id');
                }
